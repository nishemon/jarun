...
public final class PomCustomModuleDescriptorParser implements ModuleDescriptorParser {
	...
	private void addSourcesAndJavadocArtifactsIfPresent(final PomModuleDescriptorBuilder mdBuilder,
	...
	private ParseException newParserException(final Exception e) {
